...
st.markdown(
"""
E-Commerce Product Analysis & Sales Forecasting Dashboard

This Streamlit app presents an interactive exploration of e-commerce product data, customer reviews, 
and sales predictions. It integrates:

- Exploratory Data Analysis (EDA): Product catalog insights, pricing, customer rating trends
- Natural Language Processing (NLP): Sentiment analysis and topic modeling on product reviews
- Predictive Modeling: Sales forecasting using Polynomial Ridge, Random Forest, and XGBoost models
- Interactive Sales Prediction: Real-time scenario forecasting via CSV upload or manual input

Designed to support data-driven decision making, this dashboard provides intuitive visualizations 
and actionable business insights for product managers, marketers, and analysts.
"""
)
# Sections for tooltip
sections = [
    "1. Exploratory Data Analysis (EDA)",
    "2. Neural Language Processing (NLP)",
    "3. Predictive Modeling",
    "4. Interactive Sales Prediction",
]

st.sidebar.title("Navigation")
choice = st.sidebar.selectbox("Go to section", sections)
if choice == "1. Exploratory Data Analysis (EDA)":
    # Eda Header
...
elif choice == "2. Neural Language Processing (NLP)":
    # NLP header 
...
elif choice == "4. Interactive Sales Prediction":
